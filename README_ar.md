...
| تطبيقات Apple         |     1 | إسقاط قائمة IPA موثقة إلى جذور التطبيق والمكونات وعائلات وقت التشغيل وفرضيات الجسور المعلّمة بوضوح                                                                                                             |
| تطبيقات Android       |     1 | إسقاط قائمة APK موثقة إلى المكونات وعائلات وقت التشغيل وفرضيات الجسور المعلّمة بين الشيفرة المُدارة والأصلية                                                                                                   |
| تحديد وقت التشغيل     |     1 | تحديد عائلات وقت التشغيل دون تنفيذ مع ملاحظات دقيقة للقطع وتقارير صريحة عن توفر موفري التحليل الدلالي                                                                                                          |
