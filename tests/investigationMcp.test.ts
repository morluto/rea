...
describe("investigation MCP workflows", () => {
  ...
  it("replays a selected complete run after input access is removed", async () => {
    ...
    try {
      ...
      if (result.investigation_run === undefined)
        throw new Error("missing investigation run summary");
