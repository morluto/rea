...
import { runDoctor } from "../dist/application/Doctor.js";
import { runDirectAnalysis } from "../dist/application/DirectAnalysis.js";
import { runSetup } from "../dist/application/Setup.js";
...
const cli = Cli.create(PRODUCT_IDENTITY.cliBinary, {
  ...
  mcp: {
    command: PRODUCT_IDENTITY.mcpBinary,
    instructions:
...
cli.command("analyze", {
  description: "Analyze a binary through the beta.3 MCP server",
  args: z.object({
...
cli.command("decompile", {
  description: "Decompile an address through the beta.3 MCP server",
  args: z.object({
