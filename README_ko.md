...
[![85 MCP tools](https://img.shields.io/badge/MCP_tools-85-5c4ee5?style=flat-square)](#85개-도구로-구성된-워크벤치)
[![Node.js 22+](https://img.shields.io/badge/Node.js-22.19%2B-339933?style=flat-square&logo=nodedotjs&logoColor=white)](https://nodejs.org/)
[![MIT license](https://img.shields.io/badge/license-MIT-f4c430?style=flat-square)](LICENSE)

[빠른 시작](#빠른-시작) · [바이너리에서 동작까지](#바이너리에서-동작까지) · [85개 도구](#85개-도구로-구성된-워크벤치) · [작동 방식](#작동-방식) · [FAQ](#faq)
...
| Managed PE/CLI      |   2 | 읽기 전용 PE/CLI 분류, 어셈블리/모듈 ID, 대상 프레임워크, 참조, 리소스, 속성                                         |
