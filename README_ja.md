...
| Apple アプリケーション   |   1 | 認証済み IPA インベントリをアプリケーションルート、コンポーネント、ランタイムファミリー、明示的なブリッジ仮説へ投影                                                                                       |
| Android アプリケーション |   1 | 認証済み APK インベントリをコンポーネント、ランタイムファミリー、明示的な managed-to-native ブリッジ仮説へ投影                                                                                            |
| ランタイム識別           |   1 | 実行せずにランタイムファミリーを識別し、正確なアーティファクト観測とセマンティックプロバイダーの可用性を明示                                                                                              |
